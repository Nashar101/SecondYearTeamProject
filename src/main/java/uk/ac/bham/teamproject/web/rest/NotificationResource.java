...
import uk.ac.bham.teamproject.repository.NotificationRepository;
import uk.ac.bham.teamproject.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uk.ac.bham.teamproject.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                if (notification.getFeature() != null) {
                    existingNotification.setFeature(notification.getFeature());
                }
                ...
                if (notification.getReceivedDate() != null) {
                    existingNotification.setReceivedDate(notification.getReceivedDate());
                }
