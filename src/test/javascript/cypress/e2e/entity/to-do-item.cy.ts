...
describe('ToDoItem e2e test', () => {
  ...
  const toDoItemSample = { toDoItemHeading: 'Account Pizza drive', toDoItemStatus: '2023-03-21T12:42:16.872Z' };
  ...
  describe('ToDoItem page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit ToDoItem page and go back', () => {
      ...
      it('edit button click should load edit ToDoItem page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('ToDoItem');
  ...
  describe('new ToDoItem page', () => {
    ...
    it('should create an instance of ToDoItem', () => {
      cy.get(`[data-cy="toDoItemHeading"]`).type('North Associate').should('have.value', 'North Associate');

      cy.get(`[data-cy="toDoItemDescription"]`)
        .type('emulation Handcrafted withdrawal')
        .should('have.value', 'emulation Handcrafted withdrawal');

      cy.get(`[data-cy="toDoItemStatus"]`).type('2023-03-21T17:21').blur().should('have.value', '2023-03-21T17:21');
